...
<center>
    <form method="POST" action="editAppointment_action.php" enctype="multipart/form-data">
        <table border="0" width="50%">
            ...
            <td><input type="text" name="appDetail" size="50" value="<?php echo $appDetail?>"></td>
            </tr>
			
			<tr>
            <td><b>Contact Number : </b></td>
            <td><input type="text" name="menteeContact" size="50" value="<?php echo $menteeContact?>"></td>
            </tr>
			...
			<td>
            	<div class="form-group">
					...
					<input type="date" class="form-control" placeholder="appointment date" name="appDate" value="<?php echo $appDate?>">
				</div>
			</div><br>
			</td>
            </tr>
