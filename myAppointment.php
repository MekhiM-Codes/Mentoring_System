...
<div class="breadcrumbs" data-aos="fade-in">
      <div class="container">
        ...
        <p>Below is the list of all your appointments with your mentor. You can edit the details or cancel your mentoring appointment here.</p>
    </div>
</div><!-- End Breadcrumbs -->
&nbsp;
<body>
...
<div class="card">
			 ...
			 $sql = "SELECT mentors.mentorName , mentors.mentorEmail, mentors.mentor_phone_num, appointment.appDetail, appointment.menteeContact, appointment.appDate, appointment.appTime, appointment.appChoice, appointment.appChoice, appointment.appStatus, appointment.appID
					FROM mentors
					RIGHT JOIN appointment
					on appointment.mentorID = mentors.mentorID
                        ...
                        if(mysqli_num_rows($result) > 0){
                                ...
                                echo "<table id='customers'>";
                                    echo "<tr>";
										...
										echo "<th>Mentor</th>";
                                        echo "<th>Email</th>";
										echo "<th>Mentor Contact</th>";
										echo "<th>Detail</th>";
										echo "<th>Your Contact</th>";
										echo "<th>Date</th>";
										echo "<th>Time</th>";
										echo "<th>Type</th>";
										echo "<th>Status</th>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
											?>
											<a href="editAppointment.php?appID=<?php echo $row['appID'] ?>">
