...
<div class="breadcrumbs" data-aos="fade-in">
      <div class="container">
        ...
        <p>Manage registered users in FKI E-Mentoring system.</P>
		<p><b>| Role type 1 = Admin | Role type 2 = Mentee | Role type 3 = Mentor |</b></p>
    </div>
</div><!-- End Breadcrumbs -->
&nbsp;
...
<table style = "width:100%">
		...
		<div class="card">
				...
				$no = 1;
					...
					$sql = "SELECT userID, userName, userEmail, user_phone_num, userPwd, userRole FROM users";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
											...
											<a href="deleteUser_action.php?userID=<?php echo $row['userID'] ?>">
